...
export const listOfUrlForScopes = [
  ...
  { url: "/admin/receipt-for-postpaid/add", backendScopeName: "TPCollectionWebPortal:business_rules:ALL" },
  { url: "/admin/receipt-for-postpaid/edit", backendScopeName: "TPCollectionWebPortal:business_rules:ALL" },
  ...
  { url: "/admin/color-coding/logic/add", backendScopeName: "TPCollectionWebPortal:business_rules:ALL" },
  { url: "/admin/color-coding/bill-basis", backendScopeName: "TPCollectionWebPortal:business_rules:ALL" },
  { url: "/admin/color-coding/bill-basis/add", backendScopeName: "TPCollectionWebPortal:business_rules:ALL" },
  ...
  { url: "/admin/mode-of-payment/add", backendScopeName: "TPCollectionWebPortal:business_rules:ALL" },
  { url: "/admin/denied-to-pay", backendScopeName: "TPCollectionWebPortal:business_rules:ALL" },
  { url: "/admin/denied-to-pay/setup", backendScopeName: "TPCollectionWebPortal:business_rules:ALL" },
  { url: "/admin/non-energy-type", backendScopeName: "TPCollectionWebPortal:business_rules:ALL" },
  { url: "/admin/non-energy-type/add", backendScopeName: "TPCollectionWebPortal:business_rules:ALL" },
  { url: "/admin/add-collector-type", backendScopeName: "TPCollectionWebPortal:collector_types:WRITE" },
  { url: "/admin/add-collector-type/setup", backendScopeName: "TPCollectionWebPortal:collector_types:WRITE" },
  { url: "/admin/incentive", backendScopeName: "TPCollectionWebPortal:collector_incentive_applicability:ALL" },
  { url: "/admin/incentive/add", backendScopeName: "TPCollectionWebPortal:collector_incentive_applicability:ALL" },
  { url: "/admin/import", backendScopeName: "TPCollectionWebPortal:business_rules:ALL" },
  { url: "/admin/import/minimum-payable-amount-mapping", backendScopeName: "TPCollectionWebPortal:business_rules:ALL" },
  { url: "/admin/import/ecl-consumer", backendScopeName: "TPCollectionWebPortal:business_rules:ALL" },
  { url: "/admin/import/collector-mapping", backendScopeName: "TPCollectionWebPortal:business_rules:ALL" },
  ...
  { url: '/report/reconciliation', backendScopeName: 'TPCollectionWebPortal:total_collection_report:READ' },
