...
export const DualListTransfer: React.FC<DualListTransferProps> = ({
  ...
  <div className="flex gap-4 items-start bg-white rounded shadow">
    {/* Left List */}
    <div className="flex-1">
      <div className="border rounded h-80 overflow-y-auto bg-gray-100">
        {leftList.map(agent => (
          <div
            key={agent.id}
          ...
          >
            {agent.agent_name} - {agent.primary_phone}
          </div>
        ))}
