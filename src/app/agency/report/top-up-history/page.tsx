...
const TopUpHistory = () => {
    ...
    const fetchTopUpHistory = async () => {
        ...
        try {
            const response = [
                { txnType: 'Recharge', txnAmount: 100, balanceAfterTxn: 1000, date: '2023-01-01' },
                { txnType: 'Payment', txnAmount: 50, balanceAfterTxn: 950, date: '2023-01-02' },
                { txnType: 'Recharge', txnAmount: 200, balanceAfterTxn: 1200, date: '2023-01-03' },
            ];
    ...
    return (
        <AuthUserReusableCode pageTitle="Top Up History" isLoading={isLoading}>
