...
const DailyEnergyCollectionSummary = () => {
    ...
    const getReportData = async (applyFilter = {}, page = 1) => {
        ...
        try {
            setIsLoading(true);
            const response = await energyCollectionSummaryReport(payload);
            setShowTable(true)
    ...
    //     // sub_data: [...item.collection_summary]

    return (
        <AuthUserReusableCode pageTitle="Energy Collection Summary" isLoading={isLoading}>
...
export default DailyEnergyCollectionSummary;
