  ...
  return (
    <AuthUserReusableCode pageTitle='Dashboard'>
      <form onSubmit={handleSubmit(onSubmit)} className="flex items-center space-x-4">
        <CustomizedInputWithLabel containerClass={'w-1/4'} {...register('fromDate')} errors={errors.fromDate} label='From Date' type='date' />
        <CustomizedInputWithLabel containerClass={'w-1/4'} {...register('toDate')} errors={errors.toDate} label='To Date' type='date' />
